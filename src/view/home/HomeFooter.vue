<script setup>
const beiAn = () => {
  window.location.href = 'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44133002100240'
}
const ICP = () => {
...
<template>
  ...
  <el-row style="font-size: 0.9rem;">
    <el-col :xs="8" :sm="6" :md="4" :lg="8" :xl="1" align="left">
      <span style="user-select: none">© OrganWalk. All rights reserved.</span>
    </el-col>
